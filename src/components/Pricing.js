...
import image2 from '../img/crazy_tower.jpg';
import FAQ from './FAQ';
import pricingFAQData from './pricingFAQData';
    ...
    <>
      ...
      <div className="pricing-page">
        <section className="service-pricing">
          ...
          <p>
            Our architectural design services are tailored to your specific
            project requirements. We offer both ready-made and custom design
            packages.
          </p>
          ...
          <section className="pricing-section">
            ...
            <div className="pricing-details">
              <div className="pricing-item">
                <h3>
                  Basic <p><strong>Rs. 7000</strong></p>
                </h3>
                <p>
              ...
              <div className="pricing-item">
                <h3>
                  Complete <p><strong>Rs. 14,000</strong></p>
                </h3>
                <p>
                  The deliverables includes:
                  <ul>
              ...
              <div className="pricing-item">
                <h3>
                  Full Set <p><strong>Rs. 21,000</strong></p>
                </h3>
                <p>
                  The deliverables includes:
                  <ul>
        ...
        <section className="service-pricing">
          ...
          <p>
            Our interior design services focus on creating beautiful and
            functional spaces that reflect your personal style.
          </p>
          ...
          <div className="pricing-details">
            <div className="pricing-item">
              ...
              <p>
                <strong>Starting from:</strong> Rs. 1500
              </p>
            </div>
            ...
            <div className="pricing-item">
              ...
              <p>
                <strong>Starting from:</strong> Rs. 2500
              </p>
            </div>
            ...
            <div className="pricing-item">
              ...
              <p>
                <strong>Starting from:</strong> Rs. 100/hour
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="pricing-packages">
          ...
          <p>
            We offer bundled packages for comprehensive design and construction
            projects. These packages provide cost savings and convenience.
          </p>
          ...
          <div className="package-details">
            <div className="package-item">
              ...
              <p>
                Includes architectural design, interior design, and construction
                management.
              </p>
              <p>
                <strong>Starting from:</strong> Rs. 7,000
              </p>
            </div>
            ...
            <div className="package-item">
              ...
              <p>
                Includes interior design and renovation services for a single
                room or entire home.
              </p>
              <p>
                <strong>Starting from:</strong> Rs. 3,500
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="service-pricing">
          ...
          <p>
            We provide full-service construction for residential and commercial
            projects. Our pricing is based on project scope and materials.
          </p>
          ...
          <div className="pricing-details">
            <div className="pricing-item">
              ...
              <p>
                <strong>Contact us for a quote.</strong>
              </p>
            </div>
        ...
        <section className="get-quote">
          <p>
            For a personalized quote, please contact us with your project
            details. We are happy to provide a free consultation and estimate.
          </p>
          <GetQuoteForm />
        </section>
      </div>
