  ...
  return (
    <footer>
      ...
      <p>
        ...
        <h4>Social</h4>
        <a href="https://www.instagram.com/housekaar?utm_source=qr&igsh=emp2NjhiNmh3MTF4" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          <FaInstagram />
        </a>
      </p>
      <p>
        <a href="https://www.facebook.com/share/1A7RjkoVih/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
          <FaFacebook />
        </a>
      </p>
      <p>
        <a href="https://x.com/Housekaar?t=bI_LEdCgjYrNZt-nZ8yJAg&s=08" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
          <FaXTwitter />
        </a>
      </p>
      <p>
