...
const Testimonials = () => {
  const testimonialsData = [
    ...
    {
      quote:
        'As a first-time home builder, I was quite nervous about the process. However, Housekaar made it so easy and stress-free. They patiently answered all my questions, guided me through every step, and delivered a stunning home that exceeded my expectations. Their craftsmanship is outstanding, and their team is a joy to work with. I\'m so grateful for their expertise and dedication.',
